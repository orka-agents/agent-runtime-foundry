...
func TestBrokerResponseIdentityWritesOncePerInvocation(t *testing.T) {
	for _, test := range []struct {
		...
		t.Run(test.name, func(t *testing.T) {
			...
			data, err := b.readTrackedStream(reader, c, brokerIdentityRemoteSession, nil, nil)
			if err != nil {
...
func TestBrokerResponseIdentityTrackingStillRejectsMalformedTail(t *testing.T) {
	...
	if _, err := b.readTrackedStream(strings.NewReader(stream), c, brokerIdentityRemoteSession, nil, nil); err == nil {
