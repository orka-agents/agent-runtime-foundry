...
func MaybeServe(args []string) (bool, error) {
	...
	port := foundry.FirstNonBlank(os.Getenv("PORT"), "8088")
...
func serveHostedGateway(ctx context.Context, settings hostedGatewaySettings, provider foundry.TokenProvider) error {
